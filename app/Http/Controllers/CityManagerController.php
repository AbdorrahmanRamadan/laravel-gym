...
class CityManagerController extends Controller
{
    ...
    public function edit($city_manager_id)
    {
        ...
        $city = DB::table('cities')->select('id', 'name')->where('id', $city_id)->get();
        $new_cities = $city->merge($cities);

        return view('CityManager.edit', ['cityManager' => $cityManager, 'cities' => $new_cities]);
    }
